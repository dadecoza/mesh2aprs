...
## Overview
**mesh2aprs** is a lightweight Python service that subscribes to a Meshtastic MQTT topic and publishes position reports and telemetry to the APRS‑IS network.  
